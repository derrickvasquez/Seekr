...
var searchInput = document.getElementById('search-input'); //Form 

searchForm.addEventListener('submit', function (e) {
  //takes in 'search term'
  var searchTerm = searchInput.value; //takes in 'Sort'

  var sortBy = document.querySelector('input[name="sortby"]:checked').value; //takes in limit

  var searchLimit = document.getElementById('limit').value; //making the search field required
  ...
  searchInput.value = ''; //searching reddit

  _redditapi.default.search(searchTerm, searchLimit, sortBy).then(function (results) {
    var output = '<div class="card-columns">'; //looping through posts

    results.forEach(function (post) {
      output += "\n            <div class=\"card\">\n            <img src=\"...\" class=\"card-img-top\" alt=\"...\">\n            <div class=\"card-body\">\n            <h5 class=\"card-title\">".concat(post.title, "</h5>\n            <p class=\"card-text\">").concat(shortText(post.selftext, 100), "</p>\n            <a href=\"#\" class=\"btn btn-primary\">Go somewhere</a>\n            </div>\n            </div>");
    });
    output += '</div>';
...
function errorMessage(message, className) {
  ...
  var search = document.getElementById('search'); //add error message to top of screen

  searchContainer.insertBefore(div, search); //remove message after a certain amount of time
...
//# sourceMappingURL=/Seekr.e31bb0bc.js.map